                                 ...
                                 <div class="col-md-12">
                                    <form action="" method="POST">
                                        <div class="col-lg-6 col-md-6">
                                            <button class="btn btn-danger" name="cancel" value="<?php echo $oid ?>" type="submit">Cancel</button>
                                            <button class="btn btn-success" name="confirm" value=" <?php echo $oid ?>"type="submit">Confrim</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<?php
    if(isset($_POST['confirm'])) 
    {
        ...
        $OC = "UPDATE P_Order SET Status = 'Confirmed' WHERE Order_ID = '$oid'";
        $run = mysqli_query($con,$OC);
        if($run)
            echo "<script>alert('Order has been confirmed');location.href = 'Order.php';</script>";
        else
    ...
    if(isset($_POST['cancel'])) 
    {
        ...
        $OC = "UPDATE P_Order SET Status = 'Cancelled' WHERE Order_ID = '$oid'";
        $run = mysqli_query($con,$OC);
        if($run)
            echo "<script>alert('Order has been cancelled');location.href='Order.php';</script>";
        else
            mysqli_connect_error();
    }
?>
