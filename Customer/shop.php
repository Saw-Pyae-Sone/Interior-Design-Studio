  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		      ...
		      <form action="" method="POST">
                ...
                <div class="col-lg-3 col-md-3 mb-5">
		      	...
		      	if(isset($_POST['submit']))
		      	{
					...
					$product = "SELECT * FROM ProductDetail WHERE WoodType_ID = '$WT' AND SubC_ID = '$SC'";
				...
				?>
					<div class="col-12 col-md-4 col-lg-3 mb-5 mt-5">
					  <a class="product-item add-to-cart" data-product-id="<?php echo $fetch['ProductDetail_ID']; ?>">
				...
				?>
					<div class="col-12 col-md-4 col-lg-3 mb-5 mt-5">
					  <a class="product-item add-to-cart" data-product-id="<?php echo $fetch1['ProductDetail_ID']; ?>">
	   ...
	   <script type="text/javascript">
	    ...
	    <script type="text/javascript">
		  $(document).ready(function() {
		    // Attach click event handler to the "Add to Cart" links
		    ...
		    $('.add-to-cart').on('click', function(e) {
		      ...
		      // Check if the product ID is already in the addedProducts array
		      if (addedProducts.includes(productId)) {
		        // Product already added, show a message (you can use an alert or any other notification method)
		        alert('Product has already been added to the cart.');
		        return; // Stop execution to prevent adding the product again
		      }

		      // If the product ID is not in the array, add it to the array and proceed to the server request
		      addedProducts.push(productId);

		      // Make an AJAX request to the server to update the session cart
		      $.ajax({
		        type: 'GET',
		        url: 'add_to_cart.php', // Replace with the path to your PHP script that handles session update
