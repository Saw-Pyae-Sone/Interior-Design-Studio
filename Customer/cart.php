<?php
 ...
 error_reporting(E_ALL ^ E_NOTICE);
  ...
  {
    echo "<script>alert('Pls, Choose Product first.'); window.open('shop.php','_self');</script>";
  }
?>
<!doctype html>
<html lang="en">
                      ...
                      <tbody>
                        <?php
                            ...
                            <tr>
                              ...
                              <td>$<?php echo $productData['Price'].'.00' ?> <input type="hidden" class="iprice" value="<?php echo $productData['Price']; ?>"> </td>
                              <td>
                                <input type="number" class="form-control iquantity" data-product-id="<?php echo $productId; ?>" onchange="subtotal()" min="1" max="10" value="<?php echo $productQuantity ?>">
                              </td>
                              <td class="itotal">$<?php echo $productData['Price'] ?></td>
                              <td><input type="button" class="btn btn-black btn-sm" onclick="removeProduct(<?php echo $productId; ?>)" value="X"></td>
                            </tr>
                ...
                <div class="col-md-6">
                  <div class="row mb-5">
                    <div class="col-md-6 mb-3 mb-md-0">
                      <button class="btn btn-black btn-sm btn-block" id="cancelAllBtn">Cancel All Product</button>
                    </div>
                    <div class="col-md-6">
                      <button class="btn btn-outline-black btn-sm btn-block" onclick="window.location.assign('shop.php')">Continue Shopping</button>
                    </div>
                  </div>
                </div>
